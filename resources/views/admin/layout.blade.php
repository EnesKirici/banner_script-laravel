    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-neutral-900 border-r border-white/5 flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-1">
                ...
                <a href="{{ route('admin.security-logs') }}" wire:navigate
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all {{ request()->routeIs('admin.security-logs') ? 'bg-orange-600 text-white' : 'text-neutral-400 hover:bg-white/5 hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
